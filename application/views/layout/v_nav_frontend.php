...
<nav class="main-header navbar navbar-expand-md" style="background-color: #2FA0B5;">
	...
	<a href="<?= base_url() ?>" class="navbar-brand">
      <img class width="150px" height="75px" src="<?= base_url() ?>assets/gambar/logo.png">
 <span class="brand-text font-weight-light"><b></b></span>
		...
		<div class="collapse navbar-collapse order-3" id="navbarCollapse">
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="<?= base_url() ?>" class="nav-link text-white">Beranda</a>
				</li>
			...
			<li class="nav-item">
				<?php if ($this->session->userdata('email') == "") { ?>
					<a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
						<span class="brand-text font-weight-light text-white">Masuk/Daftar</span>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
					<?php if (empty($keranjang)) { ?>
						...
						<a href="<?= base_url('belanja/cekout') ?>" class="dropdown-item dropdown-footer">Beli Sekarang</a>
					<?php } ?>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">KING'S MOTOR</a></li>
