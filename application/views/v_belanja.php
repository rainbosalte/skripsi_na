...
<h5><i class="icon fas fa-check"></i>';
			...
			<div class="col-sm-12">
				...
				<button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-save"></i> Edit Keranjang</button>
				<a href="<?= base_url('belanja/clear') ?>" class="btn btn-danger btn-flat"><i class="fa fa-recycle"></i> Bersihkan Keranjang</a>
				<a href="<?= base_url('belanja/cekout')  ?>" class="btn btn-success btn-flat"><i class="fa fa-check-square"></i> Beli Sekarang</a>
				<?php echo form_close(); ?>
				<br>
			</div>
		</div>
